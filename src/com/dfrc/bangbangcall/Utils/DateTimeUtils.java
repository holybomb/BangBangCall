...
*/
package com.dfrc.bangbangcall.Utils;
...
public class DateTimeUtils extends NgnDateTimeUtils{
	...
	public static String getTodayName(){
		if(sTodayName == null){
			sTodayName = BangBangCall.getContext().getResources().getString(R.string.day_today);
		}
		return sTodayName;
	}
	...
	public static String getYesterdayName(){
		if(sYesterdayName == null){
			sYesterdayName = BangBangCall.getContext().getResources().getString(R.string.day_yesterday);
		}
