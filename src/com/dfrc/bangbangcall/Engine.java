...
import com.dfrc.bangbangcall.services.Impl.ScreenService;
...
public class Engine extends NgnEngine{
	...
	private void showNotification(int notifId, int drawableId, String tickerText) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(BangBangCall.getContext(), notifId/*requestCode*/, intent, PendingIntent.FLAG_UPDATE_CURRENT);     

        // Set the info for the views that show in the notification panel.
        notification.setLatestEventInfo(BangBangCall.getContext(), CONTENT_TITLE, tickerText, contentIntent);
