...
*/
package com.dfrc.bangbangcall.services.Impl;
...
import com.dfrc.bangbangcall.screens.IBaseScreen;
import com.dfrc.bangbangcall.screens.ScreenHome;
...
public class ScreenService extends NgnBaseService implements IScreenService {
	...
	public boolean show(Class<? extends Activity> cls, String id) {
		...
		if(window != null){
			...
			LinearLayout layout = (LinearLayout) mainActivity.findViewById(R.id.main_center);
